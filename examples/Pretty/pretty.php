...
var_dump(Pretty::bytes(3404857760, 'GB')); // string(6) "3.17GB"
var_dump(Pretty::bytes(3404857760)); // string(6) "3.17GB"
...
var_dump(Pretty::milliseconds(3.3)); // string(5) "3.3ms"
var_dump(Pretty::useconds(3212)); // string(5) "3.2ms"
var_dump(Pretty::useconds(12)); // string(5) "12μs"
var_dump(Pretty::microseconds(3212)); // string(5) "3.2ms"
